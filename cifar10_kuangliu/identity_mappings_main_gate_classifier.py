...
def save_checkpoint(state, name):
    ...
    """
    path = '/data/chercheurs/garg191/checkpoint/cifar_resnets_modified/' + p + '/c{}_{}_3248_{}_{}'.format(args.dataset[5:], args.arch+str(args.depth), args.mod_name_suffix, args.s_no)
