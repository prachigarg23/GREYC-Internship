...
def main():
    ...
    tf_dir = 'runs_vc{}_{}_4770_{}_{}'.format(args.dataset[5:], args.arch+str(args.depth),p, args.mod_name_suffix)
...
def save_checkpoint(state, name):
    ...
    """
    path = '/data/chercheurs/garg191/checkpoint/cifar_resnets_modified_val/' + p + '/vc{}_{}_4770_{}'.format(args.dataset[5:], args.arch+str(args.depth), args.mod_name_suffix)
