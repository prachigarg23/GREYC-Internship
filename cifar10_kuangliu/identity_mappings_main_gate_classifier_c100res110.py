...
def main():
    ...
    tf_dir = 'runs_c{}_{}_3248_{}_{}'.format(args.dataset[5:], args.arch+str(args.depth),p, args.mod_name_suffix)
    ...
    if args.dataset == 'cifar10':
        ...
        baseline_dir = '/home/personnels/garg191/baselines/c100_resnet110_3248/checkpoint_final.pth'
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        info = {'tot_test_loss': test_loss, 'test_loss_gatecel': test_loss_gatecel, 'test_loss_cls': test_loss_cls, 'test_accuracy': test_accuracy, 'tot_train_loss': train_loss, 'train_loss_cls': train_loss_cls, 'train_loss_gatecel': train_loss_gatecel, 'train_accuracy': train_accuracy, 'lr': optimizer.param_groups[0]['lr'], 'gate_lr': optimizer_gate.param_groups[0]['lr']}
...
def validate(testloader, model, criterion, flag=0):
    ...
    with torch.no_grad():
        for i, (inputs, target) in enumerate(testloader):
            ...
            loss = loss_gate + classification_loss # the total loss doesn't have any significance, it's just a metric  
...
def save_checkpoint(state, name):
    ...
    """
    path = '/data/chercheurs/garg191/checkpoint/cifar_resnets_modified/' + p + '/c{}_{}_3248_{}'.format(args.dataset[5:], args.arch+str(args.depth), args.mod_name_suffix)
