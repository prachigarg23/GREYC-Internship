...
def main():
    ...
    tf_dir = 'runs_lrg1by3c{}_{}_3248_{}_{}'.format(args.dataset[5:], args.arch+str(args.depth),p, args.mod_name_suffix)
...
def save_checkpoint(state, name):
    ...
    """
    path = '/data/chercheurs/garg191/checkpoint/cifar_resnets_modified/' + p + '/lrg1by3c{}_{}_3248_{}'.format(args.dataset[5:], args.arch+str(args.depth), args.mod_name_suffix)
