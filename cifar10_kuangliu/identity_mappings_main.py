...
def main():
    ...
    tf_dir = 'runs_c{}_{}_3248_{}'.format(args.dataset[5:], args.arch+str(args.depth), args.s_no)
    writer = SummaryWriter('cifar_resnets/' + tf_dir)
    ...
    if (args.arch+str(args.depth)) in ['resnet1202', 'resnet164', 'resnet110', 'preresnet110', 'preresnet164']:
    ...
    save_checkpoint({
                ...
                'acc': test_accuracy,
                'optimizer': optimizer.state_dict(),
                }, 'checkpoint_final_{}.pth'.format(args.s_no))
...
def save_checkpoint(state, name):
    ...
    """
    path = '/data/chercheurs/garg191/checkpoint/cifar_resnets_base/c{}_{}_3248'.format(args.dataset[5:], args.arch+str(args.depth))
