...
#    loss_g = torch.tensor([0.0], device='cuda', requires_grad=True) #static variable to store the g norm
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.stride = stride
        self.gate_layer = conv3x3(inplanes, 2, stride=self.stride, kernel_size=3, bias=True, pad=1)
...
def resnet_exg_3by3tube(**kwargs):
    """
    Constructs a ResNet model.
    """
    print('\nHi, inside resnet_exg_3by3tube\n')
